...
describe('Article CRUD tests', function () {
  ...
  it('should not be able to save an courses if not logged in', function (done) {
    agent.post('/api/courses')
      .send(course)
      .expect(403)
      .end(function (courseSaveErr, courseSaveRes) {
  ...
  it('should not be able to save an courses if no title is provided', function (done) {
  ...
  it('should be able to get a single course if not signed in', function (done) {
    // Create new courses model instance
